...
class ScreensaverActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            val insetsController = mContentView.windowInsetsController
            // Immersive
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) insetsController!!.systemBarsBehavior = WindowInsetsController.BEHAVIOR_DEFAULT else  // Need supress lint for this, this is correct in api 30 but not in 31
