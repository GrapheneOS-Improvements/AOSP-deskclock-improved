...
internal class TimerNotificationBuilder {
    ...
    fun build(context: Context, nm: NotificationModel, unexpired: List<Timer>): Notification {
        ...
        if (count == 1) {
            if (running) {
                ...
                @DrawableRes val icon1: Int = R.drawable.ic_pause
                ...
                @DrawableRes val icon2: Int = R.drawable.ic_add
                ...
                @DrawableRes val icon1: Int = R.drawable.ic_start
                ...
                @DrawableRes val icon2: Int = R.drawable.ic_reset
            ...
            @DrawableRes val icon1: Int = R.drawable.ic_reset
    ...
    fun buildHeadsUp(context: Context, expired: List<Timer>): Notification {
        ...
        @DrawableRes val icon1: Int = R.drawable.ic_stop
